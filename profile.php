          ...
          <div class="line"></div>
            ...
            <nav>
                <ul id="navbar">
                    ...
                    <li><a href="donar.html">Get Involved</a></li>
    ...
    <!-- <section class="cover" >
     ...
     -->
        <div class="profilebox">
            ...
            <p class="headingline" style="text-align: left;font-size:30px;"> <img  style="width:40px; height:  height:25px;; padding-right:10px; position:relative;" >Profile</p>
<!--             
            ...
            <br> -->
              ...
              <p style="font-family: Arial, Helvetica, sans-serif;">Name  :<?php echo"". $_SESSION['name'] ;?> </p><br>
              <p style="font-family: Arial, Helvetica, sans-serif;">Email :<?php echo"". $_SESSION['email'];?> </p><br>
              <p style="font-family: Arial, Helvetica, sans-serif;">Gender:<?php echo"". $_SESSION['gender'] ;?> </p><br>
               <!-- <p style="font-family: 'Times New Roman', Times, serif;">gender  :<?php echo"". $_SESSION['gender'] ;?> </p><br>  -->
              
              <a href="logout.php" style="float: left;margin-top: 6px ;border-radius:5px; background-color: orange; color:white;padding; padding-left: 10px;padding-right: 10px;">Logout</a>
              </div>
              <br>
              <br>
