...
<body>
<header id="header">
    <div><a class="imm" href="#"><img src="https://cdn1.vectorstock.com/i/1000x1000/78/40/food-word-text-typography-design-logo-icon-vector-21127840.jpg" class="logo" alt=""></a></div>
        <div class="hamburger">
            <div class="line"></div>
            <div class="line"></div>
            <div class="line"></div>
...
?>
    <style>
        ...
        <div class="itm" >
            ...
            <img src="https://assets-global.website-files.com/638fa1643a4930af84904e91/639205631e5410246ab651ee_Trips-GIF.gif" alt=""> 
...
LEFT JOIN admin ad ON fd.assigned_to = ad.Aid where assigned_to IS NULL and   delivery_by IS NULL and fd.location='$city';
";
